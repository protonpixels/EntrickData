...
class ProjectType(Enum):
    ...
    DATA_CHAT = "data_chat"
    DATA_SYNTHESIZER = "data_synthesizer"  # NEW
    ...
    def get_display_name(cls, project_type):
        return {
            ...
            cls.DATA_SYNTHESIZER.value: "🧬 Data Synthesizer"  # NEW
    ...
    def get_icon(cls, project_type):
        return {
            ...
            cls.DATA_CHAT.value: "💬",
            cls.DATA_SYNTHESIZER.value: "🧬"  # NEW
        }.get(project_type, "📁")
    ...
    def get_description(cls, project_type):
        return {
            ...
            cls.DATA_SYNTHESIZER.value: "Automated list/table generation from multiple sources using patterns and AI"  # NEW
        }.get(project_type, "")